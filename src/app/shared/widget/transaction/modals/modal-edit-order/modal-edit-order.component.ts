    ...
    if (this.status == 0 || this.status == 1) {
      if (this.orderSelected.products[position].free_shipping) {
        ...
        if (!this.orderSelected.products[position].tax_manually) {
          ...
          if (
            this.orderSelected.products[position].selected_tax === "1" ||
            this.orderSelected.products[position].selected_tax != null
          ) {
  ...
  calculateDiscount(position: number) {
    if (this.status == 0 || this.status == 1) {
      if (this.orderSelected.products[position].discount > 0) {
        this.orderSelected.products[position].discount =
          this.orderSelected.products[position].sub_total -
          this.orderSelected.products[position].sub_total *
