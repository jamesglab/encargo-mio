...
export const insertOnlyLocker = (form: any, order_service: string): any => {

    let data = {
        "locker": form.user.locker_id,
        "guide_number": form.guide_number.guide_number ? form.guide_number.guide_number : form.guide_number,
